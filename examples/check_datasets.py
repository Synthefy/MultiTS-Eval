...
from musedfm.data import Benchmark, Dataset
from musedfm.data.dataset import Dataset as DatasetClass
import json
...
def check_datasets(benchmark_path: str):
    ...
    config_path = Path(__file__).parent.parent / "src/musedfm/data/dataset_config.json"
