...
Usage:
    python run_museval_parallel.py --models mean,arima,linear --data-path /path/to/dataset
    python run_museval_parallel.py --models all --windows 50
    python run_museval_parallel.py --models all --num-processes 4
    python run_museval_parallel.py --help
"""
...
from museval.examples.utils import (
    _aggregate_metrics, _aggregate_results_by_level
)
from museval.examples.model_handling import (
    parse_models
)
from museval.examples.debug import (
...
from museval.examples.export_csvs import (
    export_hierarchical_results_to_csv
)
from museval.examples.eval_museval import (
    SaveManager
)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python run_museval_parallel.py --models mean,arima --benchmark-path /path/to/benchmark
  python run_museval_parallel.py --models all --windows 50 --plots
  python run_museval_parallel.py --models linear_trend,exponential_smoothing --windows 20
  python run_museval_parallel.py --models all --categories Traditional --domains Energy
  python run_museval_parallel.py --models mean --datasets al_daily,bitcoin_price --plots
  python run_museval_parallel.py --models all --num-processes 4
  python run_museval_parallel.py --models mean,arima --windows 100 --num-processes 2
        """
    )
