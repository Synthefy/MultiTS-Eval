...
from museval.data.special_loaders.open_aq_special import OpenAQSpecialLoader
from museval.data.special_loaders.kitti_special import KITTISpecialLoader
from museval.data.special_loaders.ecl_special import ECLSpecialLoader
